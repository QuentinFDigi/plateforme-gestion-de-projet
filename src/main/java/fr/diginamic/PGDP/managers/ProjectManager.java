...
public class ProjectManager {
    ...
    public ProjectDto findById(long id) {
        return projectTransformer.projectToProjectDto(projectRepository.findById(id).orElseThrow(() -> new ProjectNotFoundException(String.valueOf(id))));
    }
    ...
    public Collaboration verifyUser(long id) {
        Project project = projectRepository.findById(id).orElseThrow(() -> new ProjectNotFoundException(String.valueOf(id)));
...
//        return projectDtos;
    ...
    public List<UserDto> allUserInProject(long idProject) {
        Project project = projectRepository.findById(idProject).orElseThrow(() -> new ProjectNotFoundException(String.valueOf(idProject)));
